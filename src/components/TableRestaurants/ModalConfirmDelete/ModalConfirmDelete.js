...
class ModalConfirmDelete extends Component {
  ...
  handleSubmit(e) {
    axios.delete(`http://localhost:3000/restaurant/${this.props.restaurant._id}`,{
  ...
  render() {
    return (
      <Modal
        ...
        size='tiny'
      >
        <Modal.Header>Deletar restaurante</Modal.Header>
        <Modal.Content>
          <p>Tem certeza que deseja deletar o restaurante: <strong>{this.props.restaurant.name}</strong>?</p>
        </Modal.Content>
        <Modal.Actions>
